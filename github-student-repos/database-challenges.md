Repo Name: database-challenges

Description: Database and Active Record challenges for Delta cohort
...
This repository holds the database and Active Record pair programming challenges for the 2022 Delta cohort.
