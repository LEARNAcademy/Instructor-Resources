Repo Name: react-challenges

Description: React challenges for Delta cohort

Initialize: public, with a .gitignore (node), with a README
...
This repository holds the React pair programming challenges for the 2022 Delta cohort.
...
Branches and projects names should be in all lowercase letters with no spaces:
...
Use this command if you are cloning an existing React app (aka you didn't run `yarn create react-app`):
