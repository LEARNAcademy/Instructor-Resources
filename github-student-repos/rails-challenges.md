Repo Name: rails-challenges

Description: Rails challenges for Delta cohort

Initialize: public, with a .gitignore (rails), with a README
...
This repository holds the Rails pair programming challenges for the 2022 Delta cohort.
...
- Branch name: `topic-initials1-initials2` (ex. validations-aw-sp)
- Project name: `topic-name1-name2` (ex. validations-austin-sarah)
...
Use these commands if you are cloning an existing Rails app (aka you didn't run `rails new`):
